...
export function createHomeHandlers({ app, store }) {
  ...
  async function handleSendDailyUpdate({ ack, body, client, logger }) {
    ...
    const draft = {
      main_update_text: getInputValue(viewState, 'daily_update_main_block', 'daily_update_main_text'),
    ...
    const settings = store.updateSettings({
      ...
      daily_update_thread_message: getInputValue(
        viewState,
  ...
  async function handleSaveWelcomerSettings({ ack, body, client }) {
    ...
    store.updateSettings({
      ...
      welcome_message_content: getInputValue(viewState, 'welcome_message_block', 'welcome_message_content'),
  ...
  async function handleSaveGeneralSettings({ ack, body, client }) {
    ...
    const personalChannelId = getConversationSelectValue(viewState, 'personal_channel_block', 'personal_channel_id');
